...
class Jenis extends CI_Controller {
	...
	public function tambah()
	{
		...
		$valid->set_rules('NAMA_JENIS_OBAT','Nama_jenis','required|min_length[5]|max_length[32]|is_unique[T_JENIS_OBAT.NAMA_JENIS_OBAT]',
		...
		// Masuk database
			...
			$i = $this->input;
			$data = array(	'NAMA_JENIS_OBAT'			=> $i->post('NAMA_JENIS_OBAT'));
	...
	public function edit($id_jenis)
	{
		...
		// Masuk database
			...
			$i = $this->input;
			$data = array(	'ID_JENIS_OBAT'			=> $id_jenis,
							'NAMA_JENIS_OBAT'		=> $i->post('NAMA_JENIS_OBAT')
						);
